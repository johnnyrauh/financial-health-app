  ...
  return (
    <div className="py-4 sm:py-8">
      <motion.h2
        ...
        viewport={{ once: true }}
        className="text-xl sm:text-2xl font-bold text-slate-900 text-center mb-2"
      >
        Score Breakdown
      </motion.h2>
      <motion.p
        ...
        viewport={{ once: true }}
        className="text-slate-600 text-center mb-4 sm:mb-8 text-sm sm:text-base"
      >
        ...
        {CATEGORIES.map((category, index) => {
          ...
          return (
            <motion.div
              ...
              className="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-sm border border-slate-100 hover:shadow-md transition-shadow"
            >
